...
class Player:
    def __init__(self, master):
        ...
        self.threads = []
        def get_icon():
            self.winicon = PhotoImage(file="tb.png")
        ...
        self.img1 =  self.img1.resize((600, 500), Image.ANTIALIAS)
        ...
        self.buttonPlayall = Button(
            ...
            bg='black', fg='white', font='Helvetica, 15' , bd=5,width=3,command=play_all)
...
def main():
    ...
    root.title("Manikanta Music Player")
